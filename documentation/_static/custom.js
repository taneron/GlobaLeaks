document.addEventListener("DOMContentLoaded", function() {
    ...
    banner.innerHTML = '<img src="https://raw.githubusercontent.com/globaleaks/globaleaks-whistleblowing-software/stable/brand/assets/svg/heart.svg" class="donation-icon" alt="Donate" /> Globaleaks is free and open-source whistleblowing software.<br /><a href="https://github.com/sponsors/globaleaks">Donate here to support its development!</a>';
